...
#outer function - name of the custom decorator
    #wraps
    #inner function
        #stuff to run before decorated fucntion runs
        #retuns decorated function
    #returns inner function

def token_required(api_route):
    @wraps(api_route)
    def decorator_function(*args, **kwargs): #basically accepting anything the function needs
        #the code here will run before the decorated route runs
        #get the api token form the request headers
